    ...
    return (
        <Wrapper>
            <Amount>
                ...
                <Warning style={{ color: amount > 0 && '#0a0b0d' }}>
                    Amount is a required field
                </Warning>
            </Amount>
            <TransferForm>
                <Row>
                    <FiledName>To</FiledName>
                    <Icon>
                        <FaWallet />
                    </Icon>
                    <Recipient
                ...
                <Divider />
                <Row>
                    <FiledName>Pay with</FiledName>
                    <CoinsSelectList onClick={() => setAction('select')}>
                        <Icon>
...
const Recipient = styled.input`
    ...
    width: 100%;
`
const CoinsSelectList = styled.div`
    display: flex;
    flex: 1.3;
    height: 100%;
